<div id="layoutSidenav_content" class="d-flex flex-column min-vh-100">
    <main class="flex-grow-1">
        <div class="container-fluid px-4">
            ...
            <div class="mb-3">
                <a href="<?php echo base_url(); ?>cajas" class="btn btn-primary">
                    Cajas
                </a>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($datos as $dato) { ?>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <a href="#" data-href="<?php echo base_url() . 'cajas/reingresar/' . $dato['id']; ?>" data-entidad="Caja" data-nombre="<?php echo $dato['nombre']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-placement="top" title="Reingresar registro" class="btn btn-secondary">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Reingresar Caja</h1>
