<div id="layoutSidenav_content" class="d-flex flex-column min-vh-100">
    <main class="flex-grow-1">
        <div class="container-fluid px-4">
            ...
            <div class="mb-3">
                <a href="<?php echo base_url(); ?>cajas/nuevo" class="btn btn-primary">
                    <i class="fa-solid fa-plus"></i> Agregar
                </a>
                <a href="<?php echo base_url(); ?>cajas/eliminados" class="btn btn-warning">
                        ...
                        <tbody>
                            <?php foreach ($datos as $dato) { ?>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() . 'cajas/arqueo/' . $dato['id']; ?>" class="btn btn-primary">
                                            <i class="fa-brands fa-wpforms"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="<?php echo base_url() . 'cajas/editar/' . $dato['id']; ?>" class="btn btn-secondary">
                                            <i class="fa-solid fa-pen-to-square"></i> Editar
                                        </a>
                                    </td>
                                    <td>
                                        <a href="#" data-href="<?php echo base_url() . 'cajas/eliminar/' . $dato['id']; ?>" data-entidad="Caja" data-nombre="<?php echo $dato['nombre']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-placement="top" title="Eliminar registro" class="btn btn-danger">
