<div id="layoutSidenav_content" class="d-flex flex-column min-vh-100">
  <main class="flex-grow-1">
    <div class="container-fluid px-4">
      ...
      <div class="mb-3">
        <a href="<?php echo base_url(); ?>unidades" class="btn btn-primary">
          <i class="fa-solid fa-arrow-left"></i> Unidades
        </a>
      </div>
              ...
              <?php foreach ($datos as $dato) { ?>
                <tr class="align-middle">
                  ...
                  <td class="text-center">
                    <a href="#" data-href="<?php echo base_url() . 'unidades/reingresar/' . $dato['id']; ?>" data-entidad="Unidad" data-nombre="<?php echo $dato['nombre']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-placement="top" title="Reingresar registro" class="btn btn-success">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Reingresar Unidad</h1>
...
<script>
  // Script para mostrar el nombre de la unidad en el modal
  document.addEventListener('DOMContentLoaded', function() {
    const modal = document.getElementById('modal-confirma');
    modal.addEventListener('show.bs.modal', function(event) {
      const button = event.relatedTarget; // Botón que activó el modal
      const nombre = button.getAttribute('data-nombre'); // Obtener el nombre de la unidad
      const entidad = button.getAttribute('data-entidad'); // Obtener la entidad (Unidad)
