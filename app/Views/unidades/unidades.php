<div id="layoutSidenav_content" class="d-flex flex-column min-vh-100">
    <main class="flex-grow-1">
        <div class="container-fluid px-4">
            ...
            <div class="mb-3">
                <a href="<?php echo base_url(); ?>unidades/nuevo" class="btn btn-primary">
                        ...
                        <tbody>
                            <?php foreach ($datos as $dato) { ?>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() . 'unidades/editar/' . $dato['id']; ?>" class="btn btn-secondary">
                                            <i class="fa-solid fa-pen-to-square"></i> Editar
                                        </a>
                                    </td>
                                    <td>
                                        <a href="#" data-href="<?php echo base_url() . 'unidades/eliminar/' . $dato['id']; ?>" data-entidad="Unidad" data-nombre="<?php echo $dato['nombre']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-placement="top" title="Eliminar registro" class="btn btn-danger">
