                        ...
                        <tbody>
                            <?php foreach ($datos as $dato) { ?>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <a href="#" data-href="<?php echo base_url() . 'usuarios/reingresar/' . $dato['id']; ?>" data-entidad="Usuario" data-nombre="<?php echo $dato['nombre']; ?>" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-placement="top" title="Reingresar registro" class="btn btn-secondary">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Reingresar Usuario</h1>
