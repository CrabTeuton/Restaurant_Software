<div id="layoutSidenav_content" class="d-flex flex-column min-vh-100">
  <main class="flex-grow-1">
    <div class="container-fluid px-4">
      ...
      <div class="mb-3">
        <a href="<?php echo base_url(); ?>categorias" class="btn btn-primary">Categorías</a>
      </div>
              ...
              <?php foreach ($datos as $dato) { ?>
                <tr class="align-middle">
                  ...
                  <td class="text-center">
                    <a href="#" data-href="<?php echo base_url() . 'categorias/reingresar/' . $dato['id']; ?>"
                      data-entidad="Categoría" data-nombre="<?php echo $dato['nombre']; ?>"
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Reingresar Categoría</h1>
